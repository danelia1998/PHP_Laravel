...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header" style="background-color: darkolivegreen;">Create Config</div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control @error('key') is-invalid @enderror" name="key"
                                        value="{{ $config->key }}" requiredautofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control @error('value') is-invalid @enderror"
                                        name="value" value="{{ $config->value }}" requiredautofocus>
